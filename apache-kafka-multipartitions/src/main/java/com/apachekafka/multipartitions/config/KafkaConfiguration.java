package com.apachekafka.multipartitions.config;
...
{
	public static final String GROUP_ID = "three_partitions_grp_id";

	public static final String SERVER = "192.168.1.132:9092";

	public static final String TOPIC = "THREE_PARTITIONS";
